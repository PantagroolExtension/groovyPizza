...
class PizzaControllerSpec extends Specification {
    ...
    def populateValidParams(params) {
        ...
        params << [name: "pizza", pizzaFactory: pizzaFactory]
    }

   void "Test order method" () {
        when: "Test order method"
            populateValidParams(params)
            Pizza pizza = new Pizza(params)
            pizza.pizzaFactory.pizzas << pizza
            controller.order()
    ...
    void "Test pizza method" () {
        when: "Test pizzas method"
            populateValidParams(params)
            Pizza pizza = new Pizza(params)
            pizza.pizzaFactory.pizzas << pizza
        ...
        then:"model and view are correct"
            view == "/pizza/pizzas"
            model.pizzas
    }
